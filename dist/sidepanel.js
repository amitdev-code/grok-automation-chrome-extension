...
const DOWNLOAD_FOLDER_PREFIX = "GrokAutomation";
...
function getOutputFolder(projectName) {
...
function ProjectList({
  ...
  if (projects.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-gray-50 border border-gray-100 p-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:folder-open-outline", className: "w-10 h-10 text-gray-300 mx-auto mb-2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 font-poppins", children: "No projects yet." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-1", children: "Create one to get started." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: projects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "li",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 mt-0.5", children: [
            ...
            " prompt",
            project.prompts.length !== 1 ? "s" : ""
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mt-0.5 truncate", children: [
            getOutputFolder(project.name),
            "/"
          ] }),
          project.lastRunAt ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 mt-0.5", children: [
            "Last run: ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:pencil-outline", className: "w-3.5 h-3.5" }),
                "Edit"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: "inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-xl border border-gray-200 text-gray-700 hover:bg-gray-50 font-medium transition-colors",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:content-copy", className: "w-3.5 h-3.5" }),
                "Duplicate"
              ]
            }
          ),
          !isInQueue(project.id) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:playlist-plus", className: "w-3.5 h-3.5" }),
                "Add to queue"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:delete-outline", className: "w-3.5 h-3.5" }),
                "Delete"
              ]
            }
          )
...
const VIDEO_QUALITIES = ["480p", "720p"];
const VIDEO_LENGTHS = ["6", "10"];
const btnBase = "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-xl px-3 py-2 text-sm font-medium transition-all duration-150 select-none";
...
function ProjectForm({ project, onSave, onCancel }) {
  ...
  const [settings, setSettings] = reactExports.useState(initial.settings);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-1.5 text-xs font-medium text-gray-500 uppercase tracking-wide mb-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:folder-edit-outline", className: "w-3.5 h-3.5" }),
        "Project name"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mt-1.5", children: [
        "Saves to: Downloads/…/",
        getOutputFolder(name || "project"),
        "/"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-1.5 text-xs font-medium text-gray-500 uppercase tracking-wide mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:aspect-ratio", className: "w-3.5 h-3.5" }),
        "Aspect ratio"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ASPECT_RATIOS.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: VIDEO_QUALITIES.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-1.5 text-xs font-medium text-gray-500 uppercase tracking-wide mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:clock-outline", className: "w-3.5 h-3.5" }),
          "Duration"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: VIDEO_LENGTHS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-1.5 text-xs font-medium text-gray-500 uppercase tracking-wide", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:text-box-multiple-outline", className: "w-3.5 h-3.5" }),
          "Prompts"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:upload-outline", className: "w-3.5 h-3.5" }),
                "Upload .txt"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:plus", className: "w-3.5 h-3.5" }),
                "Add prompt"
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: promptList.map((value, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            value,
        ...
        promptList.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            title: "Remove prompt",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:close", className: "w-4 h-4" })
          }
        )
      ] }, index)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mt-1.5", children: [
        promptList.filter((p) => p.trim()).length,
        " prompt(s). Add at least one."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "rounded-2xl bg-gray-50 border border-gray-100 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { className: "flex items-center gap-2 px-4 py-2.5 text-xs font-medium text-gray-500 cursor-pointer hover:bg-gray-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:cog-outline", className: "w-3.5 h-3.5" }),
        "Advanced (model & outputs)"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 grid gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-gray-500 mb-1", children: "Model" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              children: MODELS.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: m.value, children: m.label }, m.value))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-xs text-gray-500 mb-1", children: [
            "Outputs per prompt (",
            outputsMin,
            "–",
            outputsMax,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:content-save-outline", className: "w-4 h-4" }),
            "Save project"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:close", className: "w-4 h-4" }),
            "Cancel"
          ]
        }
      )
...
function QueueView({
  ...
  const queueProjects = queueOrder.map((id) => projects.find((p) => p.id === id)).filter((p) => !!p);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-gray-200 rounded-2xl p-4 bg-white shadow-sm font-poppins", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "flex items-center gap-2 text-xs font-medium text-gray-500 uppercase tracking-wide mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:playlist-play", className: "w-4 h-4" }),
      "Queue"
    ] }),
    queueProjects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-2 text-sm text-gray-500 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:playlist-remove", className: "w-4 h-4 text-gray-400" }),
      "Add projects from the list above."
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: queueProjects.map((project, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        className: `flex items-center justify-between gap-2 py-2 px-3 rounded-xl transition-colors ${project.id === currentProjectId ? "bg-blue-50 border border-blue-100" : "hover:bg-gray-50"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-500 w-5", children: [
            index + 1,
            "."
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "Move up",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:chevron-up", className: "w-4 h-4" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: "p-1 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 disabled:opacity-40 transition-colors",
                title: "Move down",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:chevron-down", className: "w-4 h-4" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:close", className: "w-3.5 h-3.5" })
              }
            )
          ] })
        ]
    ...
    progressLabel && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 p-3 rounded-xl bg-amber-50 border border-amber-200 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:progress-clock", className: "w-4 h-4 text-amber-600 shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-amber-800 mb-0.5", children: "Current step" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-amber-900 break-words", children: progressLabel })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:play", className: "w-4 h-4" }),
            "Run all"
          ]
        }
      ),
      isRunning && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: isPaused ? "mdi:play" : "mdi:pause", className: "w-4 h-4" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:stop", className: "w-4 h-4" }),
              "Terminate"
            ]
          }
        )
...
function GlobalSettingsForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-poppins", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-gray-200 rounded-2xl p-4 bg-white shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "flex items-center gap-2 text-sm font-semibold text-gray-900 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:speedometer", className: "w-4 h-4 text-gray-500" }),
        "Performance & safety"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-gray-600 mb-0.5", children: "Delay between prompts (ms)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
              ...
              onChange: (e) => onChange({ ...settings, promptDelayMs: Number(e.target.value) }),
              className: "w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-gray-200"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-gray-600 mb-0.5", children: "Max retries per prompt" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-gray-600 mb-0.5", children: "Render timeout (ms)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
              ...
              onChange: (e) => onChange({ ...settings, renderTimeoutMs: Number(e.target.value) }),
              className: "w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-gray-200"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: "e.g. 300000 = 5 min" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-gray-200 rounded-2xl p-4 bg-white shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "flex items-center gap-2 text-sm font-semibold text-gray-900 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:folder-download-outline", className: "w-4 h-4 text-gray-500" }),
        "Download settings"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-gray-600 mb-0.5", children: "Folder prefix (inside Downloads)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
              value: settings.downloadFolderPrefix ?? "GrokAutomation",
              onChange: (e) => onChange({ ...settings, downloadFolderPrefix: e.target.value.trim() || "GrokAutomation" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mt-0.5", children: [
            ...
            settings.downloadFolderPrefix || "GrokAutomation",
            "/{project_name}/"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 p-3 rounded-xl bg-amber-50 border border-amber-200 flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:information-outline", className: "w-4 h-4 text-amber-600 shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-amber-800 mb-1", children: "No Save As dialog?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-900", children: [
              'If Chrome still shows "Save As", turn off ',
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Ask where to save each file before downloading" }),
              ": Chrome → Settings → Downloads (or ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-amber-100 px-0.5 rounded", children: "chrome://settings/downloads" }),
              "). The extension cannot bypass this setting."
            ] })
          ] })
        ] })
      ] })
...
function App() {
  ...
  const [queueOrder, setQueueOrder] = reactExports.useState([]);
  const [globalSettings, setGlobalSettings] = reactExports.useState(null);
  ...
  const [progressLabel, setProgressLabel] = reactExports.useState(null);
  const [lastError, setLastError] = reactExports.useState(null);
  const [saveAsTip, setSaveAsTip] = reactExports.useState(null);
  const [activeTab, setActiveTab] = reactExports.useState("projects");
  const loadProjects = reactExports.useCallback(() => {
  ...
  const loadGlobalSettings = reactExports.useCallback(() => {
    chrome.runtime.sendMessage({ type: MESSAGE_TYPES.GET_GLOBAL_SETTINGS }, (response) => {
      if (response && !response.type) setGlobalSettings(response);
  ...
  reactExports.useEffect(() => {
    const listener = (message) => {
      ...
      if (message.type === MESSAGE_TYPES.PROJECT_DONE) {
        setProjects(
          (prev) => prev.map(
            (p) => p.id === message.projectId ? { ...p, status: "completed" } : p
          )
        );
      }
      ...
      if (message.type === MESSAGE_TYPES.ERROR) {
        ...
        setProjects(
          (prev) => prev.map(
            (p) => p.id === currentProjectId ? { ...p, status: "error" } : p
          )
        );
      }
  ...
  const handleSetQueueOrder = (projectIds) => {
  ...
  const handleRunAll = () => {
    ...
    setProjects(
      (prev) => prev.map(
        (p) => queueOrder.includes(p.id) ? { ...p, status: "running" } : p
      )
    );
    setIsRunning(true);
    setIsPaused(false);
  ...
  const isInQueue = (id) => queueOrder.includes(id);
  if (view === null) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 flex items-center justify-center min-h-[200px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Loading..." }) });
  }
  if (view === "mode-select") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 max-w-md mx-auto bg-gray-50 min-h-screen flex flex-col items-center justify-center font-poppins", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "flex items-center gap-2 text-lg font-semibold text-gray-900 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:robot-outline", className: "w-5 h-5 text-gray-600" }),
        "Grok Automation"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-6", children: "Choose a mode to get started" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:movie-open-outline", className: "w-6 h-6 text-gray-500 shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-semibold", children: "Extended Long Video" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs text-gray-500 mt-1", children: "Long-form video generation" })
              ] })
            ]
          }
        ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 max-w-md mx-auto space-y-4 bg-gray-50 min-h-screen font-poppins", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "flex items-center gap-2 text-lg font-semibold text-gray-900", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:robot-outline", className: "w-5 h-5 text-gray-600" }),
      "Grok Automation"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 p-1 rounded-2xl bg-gray-100 border border-gray-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: () => setActiveTab("projects"),
          className: `flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all ${activeTab === "projects" ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:folder-multiple-outline", className: "w-4 h-4" }),
            "Manage Projects"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all ${activeTab === "settings" ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:cog-outline", className: "w-4 h-4" }),
            "Settings"
          ]
        }
      )
    ] }),
    saveAsTip && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:information-outline", className: "w-4 h-4 text-amber-600 shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "To avoid Save As dialog:" }),
        " ",
        saveAsTip,
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
    ...
    lastError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-800 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:alert-circle-outline", className: "w-4 h-4 text-red-600 shrink-0 mt-0.5" }),
      lastError
    ] }),
    activeTab === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-gray-900", children: "Settings" }),
      globalSettings && /* @__PURE__ */ jsxRuntimeExports.jsx(
        GlobalSettingsForm,
        {
    ...
    activeTab === "projects" && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: editingProject !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl p-5 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-gray-900 mb-4 font-poppins", children: editingProject.id ? "Edit project" : "New project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ProjectForm,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:plus", className: "w-4 h-4" }),
              "Create project"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:export", className: "w-4 h-4" }),
              "Export"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl border border-gray-200 text-gray-700 text-sm hover:bg-gray-50 cursor-pointer transition-colors font-poppins", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "mdi:import", className: "w-4 h-4" }),
          "Import",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", accept: ".json", className: "hidden", onChange: handleImport })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-medium text-gray-500 uppercase tracking-wide mb-2 font-poppins", children: "Projects" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ProjectList,
          {
            projects,
